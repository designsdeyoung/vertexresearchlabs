...
serve(async (req) => {
  ...
  try {
    ...
    let query = admin
      .from("orders")
      .select(`*, profiles!orders_profile_id_fkey(full_name, email, address_line1, address_line2, city, state, zip_code, points_balance, phone_number, magic_token, referral_code)`)
