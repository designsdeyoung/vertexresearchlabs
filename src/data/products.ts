...
export const products: Product[] = [
  ...
  },
  {
    ...
    subtitle: "5 mg of each · Research Grade",
    size: "10mg",
    price: 55,
    originalPrice: 65,
    description: "Blend of BPC-157 (5mg) and TB-500 (5mg) reference material supplied exclusively for laboratory research and analytical applications. Not for human consumption.",
    purity: "≥99%",
    testing: "Independent analytical verification",
    documentation: "Certificate of Analysis available upon request",
    intendedUse: "Laboratory research use only.",
