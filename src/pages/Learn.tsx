...
const Learn = () => {
  ...
  const learnSchema = {
    ...
    description:
      "Peer-reviewed research overviews and laboratory guides for research peptides including BPC-157, GHK-Cu, GLP3, MOTS-c, and more.",
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        ...
        description="In-depth research overviews and laboratory guides for BPC-157, GHK-Cu, GLP3, MOTS-c, Epithalon, and more. Peer-referenced, compliant, research-use context only."
        canonical="/learn"
        ogType="website"
        keywords={[
